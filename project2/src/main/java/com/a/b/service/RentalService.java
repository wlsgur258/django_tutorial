...
public class RentalService implements CommonService {
	...
	public void execute(Model model) {
		...
		Dao dao = new Dao();
		ArrayList<RentalingList> orders = dao.orders();
	...
	public MessageListView getMessageListView(int pageNumber) throws SQLException{
		...
		return new MessageListView(messageList, null, null, null, null,messageTotalCount,currentPageNumber,MESSAGE_COUNT_PER_PAGE,firstRow,endRow);
	}
